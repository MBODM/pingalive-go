...
This specific version, written in Go, is the exact same tool as the original [pingalive](https://github.com/mbodm/pingalive), that was written in Rust. For reasons see the [Why it exists](#why-it-exists) section.
