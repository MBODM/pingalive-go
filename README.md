...
The reason why this specific version exists, written in Go (the original code is written in Rust):
I just wanted to refresh my Go skills a bit and this application seems to be the perfect starter project for this.
